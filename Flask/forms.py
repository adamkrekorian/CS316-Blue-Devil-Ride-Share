...
class EditInfoFactory(FlaskForm):
    ...
    password = PasswordField("New password or enter current password to make changes:", validators = [Length(min=5, max=100, message='Your password must be at least 5 characters and no more than 100'), InputRequired(message='Must enter password to make changes')])
    confirmPassword = PasswordField("Confirm Password:", validators = [EqualTo('password'), InputRequired(message='Must confirm password')])
...
class EditRideTimeFactory(FlaskForm):
    earliest_departure = TimeField("Earliest Time of Departure:", validators = [InputRequired(message='You must enter the earliest time of departure')], format='%H:%M')
    ...
    latest_departure = TimeField("Latest Time of Departure:", validators = [InputRequired(message='You must enter the latest time of departure')], format='%H:%M')
    submit = SubmitField("Save")